...
st.markdown("<h1 style='text-align: center;'>📊 Dashboard RH AMV Sistemas</h1>", unsafe_allow_html=True)
...
with st.container():
    components.html(
        """
        <iframe 
            title="Dashboard RH AMV" 
            width="100%" 
            height="1060" 
            src="https://app.powerbi.com/view?r=eyJrIjoiODY2NzVjMWMtOGNkMS00NGM4LTgzOTUtYjBhNzM1NzkyZmYyIiwidCI6IjZhNzQxMjUxLTA0ZWMtNDA1YS1hMDE2LWZmZWNjNTlkYjg5YyJ9" 
            frameborder="0" 
...
with col1:
    ...
    - [Suporte RH](mailto:rh@amvsistemas.com.br)
    """)
