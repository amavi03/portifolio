...
st.set_page_config(
    page_title="Financeiro AMV Sistemas",
    page_icon="📊",
    layout="wide",
...
st.markdown("<h1 style='text-align: center;'>📊 Tudo sobre Financeiro AMV Sistemas</h1>", unsafe_allow_html=True)
...
with st.container():
    components.html(
        """
        <iframe 
            title="Dashboard Financeiro AMV" 
            width="100%" 
            height="1060" 
            src="https://app.powerbi.com/view?r=eyJrIjoiODFmYmY0YmUtZjcyNi00MTkyLWFjNzEtNDQ5MTUxZDM4M2MxIiwidCI6IjZhNzQxMjUxLTA0ZWMtNDA1YS1hMDE2LWZmZWNjNTlkYjg5YyJ9" 
            frameborder="0" 
...
with col1:
    ...
    - [Suporte Financeiro](mailto:financeiro@amvsistemas.com.br)
    """)
